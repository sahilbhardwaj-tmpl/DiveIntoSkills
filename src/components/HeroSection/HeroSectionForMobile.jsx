    ...
    <div className='main-container'>
        ...
        <div className='text-and-image-container'>
            <div className='subheading-container'>
                <p className='ppp'>Master Web Development with amazing resources that are available for free! Join our Newsletter and get alerted when new articles, topics or courses are published</p>
            </div>
